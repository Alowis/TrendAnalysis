...
colors <- c(
  ...
  "2-1" = "#d6b3a0",  # medium-low x, low y
  "3-1" = "#d9926a",  # medium-high x, low y
  "4-1" = "#dd6a29",  # high x, low y
  
  "1-2" = "#9cc4d2",  # low x, medium-low y
  "2-2" = "#9ea69f",  # medium-low x, medium-low y
  "3-2" = "#a08769",  # medium-high x, medium-low y
  "4-2" = "#a36229",  # high x, medium-low y
  
  "1-3" = "#5fb2d1",  # low x, medium-high y
  "2-3" = "#60979f",  # medium-low x, medium-high y
  "3-3" = "#617b69",  # medium-high x, medium-high y
  "4-3" = "#635929",  # high x, medium-high y
  
  "1-4" = "#169dd0",  # low x, high y
  "2-4" = "#16869e",  # medium-low x, high y
  "3-4" = "#166d68",  # medium-high x, high y
...
databiclim$maxicat[which(databiclim$combined_category == "1-1" |
                         ...
                         databiclim$combined_category == "2-1" |
                         databiclim$combined_category == "2-2" )]="Drying"
...
loscolors=c("Accelerating" = "#174f28","Drying" = "#dd6a29","Wetting" = "#169dd0","Decelerating" = "burlywood")
#8 categories 
# Define the nodes
brk=unique(class1)
library(ggsankey)
...
Dt1= DroughtTrends[which(FloodTrends$driver==driver[2]),c(13,5,6,85)]
...
hist(databipi$x,breaks=100,xlim=c(-5,5))
hist(databipi$y,breaks=10000,xlim=c(-5,5))
...
ggsave(paste0("D:/tilloal/Documents/LFRuns_utils/TrendAnalysis/plots/totchange_bvPIX.jpg"), pl, width=20, height=20, units=c("cm"),dpi=500) 
