...
plotchangemaps=function(basemap,catmap,datar,law="GPD",type,period=c(1951,1952),parlist,valuenames,haz){
  ...
  putn=data[which(data$outlets==330225),]
  data$outlets
  data$pointid
  datacol=names(data)
...
load(file=paste0(hydroDir,"/TSEVA_hybas/outputs/parCat07v7_drought_1950_2020.Rdata"))
load(file=paste0(hydroDir,"/TSEVA_hybas/outputs/ResCat07v7_drought_1950_2020.Rdata"))
...
### flood ----
load(file=paste0(hydroDir,"/TSEVA_hybas/outputs/parCat07v1_flood_1950_2020.Rdata"))
load(file=paste0(hydroDir,"/TSEVA_hybas/outputs/ResCat07v1_flood_1950_2020.Rdata"))
length(which(Results$catrest[,2]>0))
...
haz="drought"
Plot.change=plotchangemaps(basemap,catmap=catmap,datarD, law="GPD",type="RLchange",period=c(1951,2020),parlist,valuenames,haz=haz)
Plot.change[[1]]



ggsave(paste0("D:/tilloal/Documents/LFRuns_utils/Figures/Hybas07_RLchangev2_",haz,".jpg"),Plot.change[[1]], width=24, height=20, units=c("cm"),dpi=300)
...
haz="flood"
Plot.change=plotchangemaps(basemap,catmap=catmap,datarF, law="GPD",type="RLchange",period=c(1951,1952),parlist,valuenames,haz=haz)
Plot.change[[1]]
...
Plot.cb
ggsave(paste0("D:/tilloal/Documents/LFRuns_utils/Figures/Hybas07_bichange_dr-fl.jpg"),Plot.cb, width=24, height=20, units=c("cm"),dpi=300)
...
plotbeam=FascPlotChange(datar,outf,period=c(1950,2020),lims=c(-60, 60),q1=0.25,q2=0.75)
...
pc=unique(Paramsfl$catchment)
parcat=Paramsfl[match(pc,Paramsfl$catchment),]
tsize=16
osize=16
basemap=w2

parplot=inner_join(outf,parcat,by = c("outlets"="catchment"))
